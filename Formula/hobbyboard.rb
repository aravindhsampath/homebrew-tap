class Hobbyboard < Formula
  ...
  if OS.mac? && Hardware::CPU.arm?
    url "https://github.com/aravindhsampath/hobbyboard/releases/download/v0.1.2/hobbyboard-v0.1.2-aarch64-apple-darwin.tar.gz"
    sha256 "0831c209d0164d11873185a059c4432d111729ff8c011405b37aa4b93e4d3b7a"
  end

  # Linux (x86_64)
  if OS.linux? && Hardware::CPU.intel?
    url "https://github.com/aravindhsampath/hobbyboard/releases/download/v0.1.2/hobbyboard-v0.1.2-x86_64-unknown-linux-gnu.tar.gz"
    sha256 "b52bfb555cda97b8ba79d5072e140582ecff09609a7894e97f002a6cd60a617f"
  end

  # Linux (ARM64)
  if OS.linux? && Hardware::CPU.arm?
    url "https://github.com/aravindhsampath/hobbyboard/releases/download/v0.1.2/hobbyboard-v0.1.2-aarch64-unknown-linux-gnu.tar.gz"
